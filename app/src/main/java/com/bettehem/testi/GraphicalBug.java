...
public class GraphicalBug extends Activity implements View.OnClickListener
{	
	Button sendbtn;
	EditText issue, extra, whatrom;
	Intent emailIntent;
	String contact, subject, version, message, issuetxt, extratxt, nomodify, gfxbugsub, msgfortoast, appversion, musicsetting, whatromtxt;
	TextView text1, text2, text3, text4, iplang;
	Typeface font;
	...
	public void stuff(){
		setContentView(R.layout.gfxbug);
		...
		gfxbugsub = getString(R.string.gfxbugsub);
		appversion = getString(R.string.manappvs);
		
		contact = "bettehem@gmail.com";
		subject = gfxbugsub + " " + version + " " + appversion;
